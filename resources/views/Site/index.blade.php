...
@section('style')
    ...
    @if(json_decode($thispage->keyword))<meta name="keywords"             content="{{implode("،" , json_decode($thispage->keyword))}}"> @endif
            ...
            <div class="container mt-10px mb-10px">
                <div class="row">
                    <div class="col-lg-4 responsive-column-half">
                        <div class="info-icon-box d-flex align-items-center py-2">
...
--}}
    <section class="client-logo-area bg-gray section-padding position-relative overflow-hidden text-center">
        <div class="container">
            <div class="section-heading">
                <h2 class="section__title mb-3">برخی از موکلین</h2>
            </div>
            <div class="client-logo-carousel mt-20px">
            ...
            <div class="blog-post-carousel owl-action-styled half-shape">
                @foreach($servicelawyers as $servicelawyer)
                    <div class="col-lg-12 responsive-column-half text-center">
                        <div class="icon-element icon-element-lg shadow-sm" style="margin-bottom: -70px;position: relative;">
                            <img src="{{asset($servicelawyer->image)}}" style="width: 100px;margin: 25px auto;" alt="{{$servicelawyer->title}}">
                        </div>
                        <div class="category-item category-item-layout-2" style="position: initial;">
    ...
    <section class="get-started-area section--padding bg-gray position-relative overflow-hidden">
        <span class="stroke-shape stroke-shape-1"></span>
        <span class="stroke-shape stroke-shape-2"></span>
        <span class="stroke-shape stroke-shape-3"></span>
        <span class="stroke-shape stroke-shape-4"></span>
        ...
        <div class="container">
            ...
            <div class="blog-post-carousel owl-action-styled half-shape">
                @foreach($serviceclients as $serviceclient)
                    <div class="col-lg-12 responsive-column-half text-center">
                        <div class="icon-element icon-element-lg shadow-sm" style="margin-bottom: -70px;position: relative;">
                            <img src="{{asset($serviceclient->image)}}" style="width: 100px;margin: 25px auto;" alt="{{$serviceclient->title}}">
                        </div>
                        <div class="category-item category-item-layout-2" style="position: initial;">
                ...
                @foreach($akhbars as $akhbar)
                    ...
                    <div class="card card-item card-preview" data-tooltip-content="#tooltip_content_1">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text"> {!! $akhbar->matn !!} </p>
    ...
    <section class="about-area section--padding bg-gray overflow-hidden">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="about-content pb-5">
                        <div class="section-heading">
                            <h2 class="section__title">ارائه دهنده خدمات جامع حقوقی به سبکی نوین</h2>
                            <span class="section-divider"></span>
                            <p class="section__desc text-justify">
                                تفاوتی ندارد یک کسب و کار کوچک داشته باشید یا یک هلدینگ بین المللی، در برابر چالش‌های حقوقی همواره نیاز به یک مشاور حقوقی با تجربه و قراردادهای منسجم خواهید داشت. موسسه حقوقی دادورزان امین، این امکان را برای شما به ارمغان آورده است تا تمام امور حقوقی و ثبتی خود را بدون دغدغه و به صورت یکپارچه به تیم متخصص و باتجربه‌ای بسپارید که سال‌ها در این حوزه فعالیت داشته و به انواع مسائل و قوانین کسب و کار تسلط بالایی دارند
                            </p>
                        </div>
                        <div class="row pt-4 pb-3">
                            <div class="col-lg-4 responsive-column-half">
                                <div class="info-icon-box mb-3">
                                    <h4 class="fs-18 font-weight-semi-bold pt-3">300+ کسب وکار</h4>
                                </div>
                            </div>
                            <div class="col-lg-4 responsive-column-half">
                                <div class="info-icon-box mb-3">
                                    <h4 class="fs-18 font-weight-semi-bold pt-3">600+ دقیقه مشاور</h4>
                                </div>
                            </div>
                            <div class="col-lg-4 responsive-column-half">
                                <div class="info-icon-box mb-3">
                                    <h4 class="fs-18 font-weight-semi-bold pt-3">10+ سال تجربه</h4>
                                </div>
                            </div>
                        </div>
                        <div class="btn-box">
                            <a href="{{url('تیم-ما/درباره-ما')}}" class="btn theme-btn">بیشتر بدانید </a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-5 ml-auto">
                    <div class="generic-img-box d-none d-md-block">
                        <img src="{{asset('site/images/img-loading.png')}}" data-src="site/images/img13.jpg" alt="موسسه حقوقی" class="img__item img__item-1 lazy">
                        <img src="{{asset('site/images/img-loading.png')}}" data-src="site/images/img14.jpg" alt="شرکت حقوقی" class="img__item img__item-2 lazy">
                    </div>
                </div>
            </div>
        </div>
