...
{{--                                    </svg>--}}
{{--                                </div>--}}
{{--                                <h3 class="info__title">دفتر مرکزی</h3>--}}
{{--                                <p class="info__text">{{$companies['address']}}</p>--}}
{{--                            </div>--}}
...
{{--                                    <h2 class="section__title pb-3">عضویت در خبرنامه ما برای دریافت اخرین خبرهای حقوقی</h2>--}}
{{--                                    <p class="section__desc">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله</p>--}}
{{--                                </div>--}}
...
{{--                                            ممنون! درخواست شما ارسال شد--}}
{{--                                        </div>--}}
{{--                                        <div class="input-box">--}}
{{--                                            <label class="label-text">اسم شما</label>--}}
{{--                                            <div class="form-group">--}}
{{--                                                <input id="name" class="form-control form--control" type="text" name="name" placeholder="اسم شما" />--}}
...
{{--                                            <div class="form-group">--}}
{{--                                                <input id="email" class="form-control form--control" type="email" name="email" placeholder="آدرس ایمیل" />--}}
...
{{--                                            <div class="form-group">--}}
{{--                                                <textarea id="message" class="form-control form--control pl-4" name="message" rows="5" placeholder="پیام"></textarea>--}}
{{--                                            </div>--}}
{{--                                        </div>--}}
{{--                                        <div class="btn-box">--}}
{{--                                            <button id="send-message-btn" class="btn theme-btn" type="submit">ارسال درخواست</button>--}}
{{--                                        </div>--}}
{{--                                    </form>--}}
{{--                                </div>--}}
{{--                            </div>--}}
...
@section('main')
    ...
    <div class="container d-flex flex-column align-items-center align-self-center my-5 border br-16 p-2" id="hire">
