            ...
            <div class="col-lg-8 mr-auto">
                <div class="breadcrumb-content">
                    <ul class="generic-list-item generic-list-item-arrow d-flex flex-wrap align-items-center">
                        ...
                        <li><a href="{{url('دوره-آموزشی/'.$singleworkshops->slug)}}">{{$singleworkshops->title}}</a></li>
                    </ul>
                                ...
                                <div class="media media-card">
                                    <div class="instructor-img">
                                        <a href="#" class="media-img d-block">
                                            <img class="lazy" src="images/img-loading.png" data-src="{{asset('site/images/123.png')}}" alt="تصویر " />
                                        </a>
                            ...
                            <div class="card-body">
                                ...
                                <div class="preview-course-feature-content pt-40px">
                                    ...
                                    <div class="buy-course-btn-box">
                                        <button type="button" class="btn theme-btn w-100 theme-btn-white mb-2"><i class="la la-shopping-bag mr-1"></i>خرید / ثبت نام در دوره</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <ul class="generic-list-item generic-list-item-flash">
                                    <li class="d-flex align-items-center justify-content-between">
                                        <span><i class="mr-2 text-color"></i>مدت زمان</span> 2.5 ساعت
                                    </li>
                                    <li class="d-flex align-items-center justify-content-between">
