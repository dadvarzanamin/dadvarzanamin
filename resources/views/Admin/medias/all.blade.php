        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="deletemedia{{$media->id}}" class="btn btn-danger" data-id="{{$media->id}} " data-dismiss="modal">بله</button>
                </div>
            </div>
    ...
    @foreach($medias as $media)
        <script>
            jQuery(document).ready(function(){
                jQuery('#deletemedia{{$media->id}}').click(function(e){
                    e.preventDefault();
                    $.ajaxSetup({
                        headers: {
