        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="deletearticle{{$article->id}}" class="btn btn-danger" data-id="{{$article->id}} " data-dismiss="modal">بله</button>
                </div>
            </div>
    ...
    @foreach($articles as $article)
        <script>
            jQuery(document).ready(function(){
                jQuery('#deletearticle{{$article->id}}').click(function(e){
                    e.preventDefault();
                    $.ajaxSetup({
                        headers: {
