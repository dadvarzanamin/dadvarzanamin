                                    ...
                                    <div class="row row-sm">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <p class="mg-b-10">عنوان مقاله</p>
                                                <input type="text" name="title" id="title" placeholder="عنوان مقاله را وارد کنید" class="form-control"/>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <p class="mg-b-10">قیمت مقاله(تومان)</p>
                                                <input type="text" name="price" id="price" placeholder="قیمت مقاله را وارد کنید" class="form-control"/>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select name="type" id="type" multiple="multiple" class="form-control select-lg select2">
                                                    <option value="">انتخاب نوع مقاله</option>
