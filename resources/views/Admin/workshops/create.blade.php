                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="card custom-card">
                            <div class="card-body"
                                ...
                                <div class="row">
                                    <div class="col"><a href="{{url()->current()}}"
                                                        class="btn btn-link btn-xs">{{$thispage['enter_title']}}</a>
                                    </div>
                                    ...
                                    <div class="row row-sm">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="title" id="title"
                                                       placeholder="عنوان دوره را وارد کنید" class="form-control"/>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="teacher" id="teacher"
                                                       placeholder="استاد دوره را وارد کنید" class="form-control"/>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="price" id="price"
                                                       placeholder="قیمت دوره را وارد کنید" class="form-control"/>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="date" id="date"
                                                       placeholder="تاریخ برگزاری دوره را وارد کنید"
                                                       class="form-control"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group" style="position: absolute;">
                                                ...
                                                <input type="file" name="file_link" id="file_link" class="dropify"
                                                       data-height="200">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group" style="margin-top: 65px;">
                                                ...
                                                <textarea name="text" id="editor" cols="30" rows="5"
    ...
    <script>
        jQuery(document).ready(function () {
            jQuery('#submit').click(function (e) {
                ...
                let target = CKEDITOR.instances.editor2.getData();
                let teacher_resume = CKEDITOR.instances.editor3.getData();
                ...
                let duration = jQuery('#duration').val();
                ...
                formData.append('teacher_resume', teacher_resume);
