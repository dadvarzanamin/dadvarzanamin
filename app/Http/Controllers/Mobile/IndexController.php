...
class IndexController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($deviceDetector->isMobile()) {
            return view('mobile.index')->with(compact('menus','lastmenuid' ,'posts' ,  'thispage', 'companies', 'slides', 'customers', 'submenus', 'servicelawyers', 'serviceclients', 'akhbars', 'megamenus', 'megacounts', 'emploees'));
        } else {
            return view('Site.index')->with(compact('menus', 'thispage' ,'posts', 'companies', 'slides', 'customers', 'submenus', 'servicelawyers', 'serviceclients', 'akhbars', 'megamenus', 'megacounts', 'emploees'));
        }
    }
