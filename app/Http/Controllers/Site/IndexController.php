...
class IndexController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('Site.index')->with(compact('menus', 'thispage', 'companies', 'slides', 'customers', 'submenus', 'posts', 'servicelawyers', 'serviceclients', 'akhbars', 'megamenus', 'megacounts', 'emploees'));
